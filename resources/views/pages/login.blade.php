...
<!-- Mirrored from agileui.com/demo/monarch/demo/admin-template/login-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jul 2020 11:52:10 GMT -->
<head>
    <style>
        /* Loading Spinner */
                    ...
                    <div class="content-box-wrapper">
                        <div class="form-group">
                            <div class="input-group">
                                <input name="usr_mail" type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input name="usr_pass" type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                <span class="input-group-addon bg-blue">
